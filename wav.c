...
WAVHEADER WavHeader(uint32_t  sampleRate, uint32_t SizeData)
{
    ...
    {
        Wheader.chunkId[i] = (0x52494646>>(3-i)*8); //"RIFF"
        Wheader.format[i] = (0x57415645>>(3-i)*8);  //"WAVE"
        Wheader.subchunk1Id[i] = (0x666d7420>>(3-i)*8);
        Wheader.subchunk2Id[i] = (0x64617461>>(3-i)*8); //«data»
    }
